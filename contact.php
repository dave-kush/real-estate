                            ...
                            <ul>
                                ...
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="d-table text-white">+91 997-934-6908</span>
										<span class="text-white">+91 997-938-8604</span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-white">mydanjar5676@gmail.com</span>
										<span class="text-white">nileshdave123@gmail.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
