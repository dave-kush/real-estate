            ...
            <div class="container">
                <div class="row"><!-- FOR MORE PROJECTS visit: codeastro.com -->
					...
					<?php
						...
						$query=mysqli_query($con,"SELECT * FROM property INNER JOIN user ON property.uid = user.uid AND property.pid = '$id'" );
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="property-details">
                            ...
                            <div class="agent-contact pt-60">
                                <div class="row">
                                    <div class="col-sm-4 col-lg-3"> <img src="admin/user/<?php echo $row['23']; ?>" alt="" height="200" width="170"> </div>
                                    <div class="col-sm-8 col-lg-9">
                                        <div class="agent-data text-ordinary mt-sm-20">
                                            <h6 class="text-success text-capitalize"><?php echo $row['32'];?></h6>
                                            <ul class="mb-3">
                                                <li><?php echo $row['33'];?></li>
                                                <li><?php echo $row['34'];?></li>
                                            </ul>
